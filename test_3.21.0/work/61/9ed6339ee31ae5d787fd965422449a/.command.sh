...
def main() -> None:
    ...
    os.system(f"cat genes_with_empty_tid.filtered.gtf {add_name}.gtf > out/{output_prefix}.gtf")

    logger.info("Conversion completed successfully.")

    # Write the versions
    versions_this_module = {}
    versions_this_module["NFCORE_RNASEQ:PREPARE_GENOME:CUSTOM_CATADDITIONALFASTA"] = {"python": platform.python_version()}

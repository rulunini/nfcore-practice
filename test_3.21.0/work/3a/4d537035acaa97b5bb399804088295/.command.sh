...
if __name__ == "__main__":
    ...
    if not map_transcripts_to_gene("salmon", "genome_gfp.gtf", "quants", "gene_id", "gene_name", f"{prefix}tx2gene.tsv"):
        logger.error("Failed to map transcripts to genes.")

    # Write the versions
    versions_this_module = {}
    versions_this_module["NFCORE_RNASEQ:RNASEQ:QUANTIFY_PSEUDO_ALIGNMENT:CUSTOM_TX2GENE"] = {"python": platform.python_version()}
